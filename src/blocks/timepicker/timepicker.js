...
var content = $('<div class="timepicker">\
		<div v-show class="title">Время</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="Час"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Мин"></a></div>\
				</div>\
				<div class="handle">\
